...
internal sealed class JsonToGoGui : IGuiTool
{
                                    ...
                                    .WithSettings(
                                        _unknownTypeSetting
                                            ...
                                            .Handle(
                                                ...
                                                Item(_typeMappings[GoTypes.Any],
                                                    GoTypes.Any),
                                                Item(_typeMappings[GoTypes.StringPtr],
                                                    GoTypes.StringPtr),
                                                Item(_typeMappings[GoTypes.Interface],
                                                    GoTypes.Interface)
                                            ),
                                        Setting()
                                            .Icon("FluentSystemIcons", '\uf4a4')
    ...
    private void Convert()
    {
        ...
        var isEnableOptionalField = _settingsProvider.GetSetting(_optionalField);
        try
        {
            var converter = new JsonToGoConverter(_inputTextArea.Text, structName, unknownTypeOption,
                isEnableOptionalField);
